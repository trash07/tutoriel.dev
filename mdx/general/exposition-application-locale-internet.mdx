...
![yatcht.jpg](../../assets/images/yatcht.jpg)
...
Ensuite, on installe express, on crée le dossier **src** et on crée un fichier **index.jsx**
...
Dans le fichier **src/index.jsx** du dossier **exposition**, on va mettre le contenu suivant:
...
**package.json** et de remplacer la ligne où il y a **"main": "index.jsx"** par
**"main": "src/index.jsx"** et d'ajouter dans le bloc **scripts** la ligne
**"start": "node src/index.jsx"**. Le fichier **package.json** final ressemblera à ce qui suit.
